...
export class PopoverPositionerElement extends BaseElement implements PopoverPositionerProps {
  ...
  /** @hidden */ get onEscapeKeyDown(): PopoverPositionerProps["onEscapeKeyDown"] { return this._s.onEscapeKeyDown.value }
  /** @hidden */ set onEscapeKeyDown(v: PopoverPositionerProps["onEscapeKeyDown"]) { this._s.onEscapeKeyDown.value = v }
  /** @hidden */ get onPointerDownOutside(): PopoverPositionerProps["onPointerDownOutside"] { return this._s.onPointerDownOutside.value }
  /** @hidden */ set onPointerDownOutside(v: PopoverPositionerProps["onPointerDownOutside"]) { this._s.onPointerDownOutside.value = v }
  /** @hidden */ get onFocusOutside(): PopoverPositionerProps["onFocusOutside"] { return this._s.onFocusOutside.value }
  /** @hidden */ set onFocusOutside(v: PopoverPositionerProps["onFocusOutside"]) { this._s.onFocusOutside.value = v }
  /** @hidden */ get onInteractOutside(): PopoverPositionerProps["onInteractOutside"] { return this._s.onInteractOutside.value }
  /** @hidden */ set onInteractOutside(v: PopoverPositionerProps["onInteractOutside"]) { this._s.onInteractOutside.value = v }
}
